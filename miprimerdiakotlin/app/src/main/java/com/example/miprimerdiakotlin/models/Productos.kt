...
class Productos(private var id_producto: Int, private var id_categoria: Int, private var id_proveedor: Int, private var nombre:String, private var precio:Double){
